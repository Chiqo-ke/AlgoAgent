"""
Test file for 20251226_124041_wf_f863e941973f_ema_crossover.py
...
strategy_path = Path(__file__).parent / 'Backtest' / 'codes' / '20251226_124041_wf_f863e941973f_ema_crossover.py'
