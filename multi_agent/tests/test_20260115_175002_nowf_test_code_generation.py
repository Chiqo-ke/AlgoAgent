"""
Test file for 20260115_175002_nowf_test_code_generation.py
...
strategy_path = Path(__file__).parent / 'Backtest' / 'codes' / '20260115_175002_nowf_test_code_generation.py'
