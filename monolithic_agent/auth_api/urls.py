...
from .views import (
    ...
    ai_chat_view, health_check, change_password_view, set_subscription_view
)
...
urlpatterns = [
    ...
    # Admin: subscription management (staff only)
    path('admin/set-subscription/', set_subscription_view, name='admin-set-subscription'),
